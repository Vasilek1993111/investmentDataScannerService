...
SELECT invest.minute_candles.figi,
       ...
       min(invest.minute_candles."time")                        AS first_candle_time,
       max(invest.minute_candles."time")                        AS last_candle_time,
...
WHERE
    date((invest.minute_candles."time" AT TIME ZONE 'Europe/Moscow'::text)) = (CURRENT_DATE AT TIME ZONE 'Europe/Moscow'::text)
