...
### 2.1. [GRPC_LIMITS.md](GRPC_LIMITS.md) - Лимиты gRPC подписок

- **Лимиты T-Invest API** - детальное описание всех ограничений
- **Рекомендации по оптимизации** - лучшие практики работы с подписками
- **Примеры использования** - батчинг и обработка ошибок
- **Мониторинг** - метрики и алерты

### 2.2. [PRICE_CACHE.md](PRICE_CACHE.md) - Система кэширования цен

- **Обзор системы** - архитектура кэширования цен
- **Компоненты** - PriceCacheService, StartupPriceLoader, ScheduledPriceUpdateService
- **REST API** - endpoints для управления кэшем
- **Конфигурация** - автоматическая инициализация и обновление
- **Использование** - примеры программного использования и REST API

### 2.3. [QUOTE_SCANNER_SERVICE.md](QUOTE_SCANNER_SERVICE.md) - Детальная документация QuoteScannerService

- **Обзор сервиса** - назначение и архитектура
- **Жизненный цикл** - инициализация, обработка данных, завершение работы
- **Управление индексами** - динамическое добавление и удаление индексов
- **Управление сессиями** - контроль активности сканера
- **API методы** - полное описание всех методов сервиса
- **Конфигурация** - настройка параметров работы
- **Статистика и мониторинг** - метрики и получение статистики
- **Примеры использования** - интеграция с контроллерами и WebSocket
...
| README.md                 | ~500      | 12       | 15            |
| API.md                    | ~400      | 8        | 20            |
| GRPC_LIMITS.md            | ~333      | 7        | 10            |
| PRICE_CACHE.md            | ~352      | 10       | 15            |
| QUOTE_SCANNER_SERVICE.md  | ~700      | 12       | 20            |
