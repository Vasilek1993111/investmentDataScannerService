...
public interface ClosePriceEveningSessionRepository
    ...
    /**
     * Получить цены закрытия вечерней сессии за указанную дату для конкретных инструментов в виде
     * Map<FIGI, Price>
     * 
     * @param priceDate дата для получения цен
     * @param figis список FIGI инструментов
    ...
    List<ClosePriceEveningSessionEntity> findLastPricesByFigis(@Param("figis") List<String> figis);
